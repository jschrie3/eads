...
The `stl_get_census()` function provides access to both the American Community Survey (from 2010 onwards) and the 1990, 2000, and 2010 Decennial Census products from the U.S. Census Bureau. For example, we can obtain counts of the number of vacant housing units for the entire metro St. Louis area:
